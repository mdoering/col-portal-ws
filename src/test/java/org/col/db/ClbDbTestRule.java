...
public class ClbDbTestRule implements TestRule {
  ...
  public static ClbDbTestRule puma() {
    return new ClbDbTestRule("puma");
  }

  public static ClbDbTestRule quatsch() {
    return new ClbDbTestRule("quatsch");
  }
   ...
   *                  the db
   */
  private ClbDbTestRule(@Nullable String tsvFolder) {
