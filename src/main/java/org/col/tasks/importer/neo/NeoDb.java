package org.col.tasks.importer.neo;
...
import org.col.tasks.importer.neo.kryo.CliKryoFactory;
import org.col.tasks.importer.neo.mapdb.MapDbObjectSerializer;
import org.col.tasks.importer.neo.model.*;
...
public class NeoDb<T extends NeoTaxon> {
  ...
  private void readRelations(Node n, T obj) {
    try {
      ...
      obj.addIssue(NameUsageIssue.RELATIONSHIP_MISSING);
  ...
  protected List<Node> nodesByCanonicalAndRank(String canonical, org.gbif.api.vocabulary.Rank rank) {
  ...
  private List<Node> filterByRank(ResourceIterator<Node> nodes, org.gbif.api.vocabulary.Rank rank) {
