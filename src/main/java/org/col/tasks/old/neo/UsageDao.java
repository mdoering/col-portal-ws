...
//      }
  ...
  protected Node nodeByCanonical(String canonical) throws NotUniqueException {
    try {
      return Iterators
          .singleOrNull(getNeo().findNodes(Labels.TAXON, NeoProperties.CANONICAL_NAME, canonical));
    } catch (NoSuchElementException e) {
  ...
  protected Collection<Node> nodesByCanonical(String canonical) {
    return Iterators
        .asCollection(getNeo().findNodes(Labels.TAXON, NeoProperties.CANONICAL_NAME, canonical));
  }
  ...
  protected Node nodeBySciname(String sciname) throws NotUniqueException {
    try {
      return Iterators
          .singleOrNull(getNeo().findNodes(Labels.TAXON, NeoProperties.SCIENTIFIC_NAME, sciname));
    } catch (NoSuchElementException e) {
