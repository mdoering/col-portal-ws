...
import org.col.tasks.old.neo.NotUniqueRuntimeException;
...
public class NeoInserter implements AutoCloseable {
    ...
    public static NeoInserter create(NeoDb dao, File storeDir, int batchSize, @Nullable MetricRegistry registry) throws IOException {
